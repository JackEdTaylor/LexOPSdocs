...
```{block, type="info"}
The shiny app is also available as a web app online, at [https://jackt.shinyapps.io/lexops/](https://jackt.shinyapps.io/lexops/), but it is usually more reliable to run it locally with the `run_shiny()` function.
```

...
```{block, type = 'cite'}
Taylor, J. E., Beith, A., & Sereno, S. C. (2019, September 17). LexOPS: An R Package and User Interface for the Controlled Generation of Word Stimuli. https://doi.org/10.31234/osf.io/7sudw
```

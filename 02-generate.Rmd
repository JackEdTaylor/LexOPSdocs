...
<br>
```{block, type="info"}
Note that if you're using your own dataframe, you'll have to specify which column contains the strings with the `string_col` argument of the `generate()` function (above, `string_col = "word"`).
